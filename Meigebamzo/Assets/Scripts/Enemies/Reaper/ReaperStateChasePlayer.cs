...
public class ReaperStateChasePlayer : EnemyState
{
    public static Type StateType { get => typeof(ReaperStateChasePlayer); }
    private ReaperContext _context;
    public ReaperStateChasePlayer(GetState function) : base(function)
    {
    }
